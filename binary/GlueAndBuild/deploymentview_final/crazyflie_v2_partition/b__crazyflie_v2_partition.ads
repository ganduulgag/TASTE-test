...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_crazyflie_v2_partition" & ASCII.NUL;
   ...
   --  polyorb_hi.sporadic_task%s
   --  polyorb_hi.sporadic_task%b
   ...
   --  led_control%b
   --  tasks%s
   --  crazyflie_v2_partition_taste_api%s
   --  crazyflie_wrappers%s
   --  vt_crazyflie_start_demo_wrappers%s
   --  polyorb_hi_generated.activity%s
   --  crazyflie_v2_partition_taste_api%b
   --  crazyflie_v2_partition_taste_api_wrappers%s
   --  vt_crazyflie_pulse_wrappers%s
   --  crazyflie_v2_partition_taste_api_wrappers%b
   --  led_control_wrappers%s
   --  polyorb_hi_generated.transport%s
   --  polyorb_hi_drivers_crazyflie_ble%s
   --  polyorb_hi_generated.subprograms%s
   --  polyorb_hi_generated.marshallers%s
   --  polyorb_hi_generated.marshallers%b
   --  vt_crazyflie_start_demo_wrappers%b
   --  polyorb_hi_generated.activity%b
   --  vt_crazyflie_pulse_wrappers%b
   --  crazyflie_wrappers%b
   --  led_control_wrappers%b
   --  polyorb_hi_generated.transport%b
   --  polyorb_hi_drivers_crazyflie_ble%b
   --  polyorb_hi_generated.subprograms%b
   --  crazyflie_v2_partition%b
