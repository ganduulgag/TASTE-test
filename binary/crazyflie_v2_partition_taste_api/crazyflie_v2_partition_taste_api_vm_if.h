...
#ifndef VM_IF_crazyflie_v2_partition_taste_api
#define VM_IF_crazyflie_v2_partition_taste_api
...
extern void crazyflie_v2_partition_taste_api_PI_crazyflie_has_pending_msg (asn1SccT_Boolean *);
#ifdef __cplusplus
}
#endif
